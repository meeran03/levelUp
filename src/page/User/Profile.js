...
import {ActivityIndicator, FlatList, ScrollView, View, BackHandler,I18nManager} from 'react-native';
                ...
                <View style={{flex:1,backgroundColor:Config.background}}>
                    ...
                    <View style={style.header}>
                        ...
                        {(this.state.data.follow == '0' && this.state.follow == 0) ?
                            <Button onPress={()=>{this.follow()}} title={lan.Follow} buttonStyle={{
                            ...
                            :
                            <Button onPress={()=>{this.unfollow()}} title={lan.unfollow} buttonStyle={{
                                backgroundColor: 'transparent',
                                borderColor: '#fff',
                                borderWidth: 1,
                                borderRadius: 40,
                    ...
                    <View style={style.whiteBox}>
                        <View style={style.boxIn1}>
                            ...
                            <Text style={{fontFamily:'robotoregular',color:Config.grayColor,textAlign:'center'}}>{lan.Courses}</Text>
                        </View>
                        <View style={style.boxIn2}>
                            ...
                            <Text style={{fontFamily:'robotoregular',color:Config.grayColor,textAlign:'center'}}>{lan.Minutes}</Text>
                        </View>
                        <View style={style.boxIn3}>
                            ...
                            <Text style={{fontFamily:'robotoregular',color:Config.grayColor,textAlign:'center'}}>{lan.Followers}</Text>
                        </View>
                    </View>
                    <View style={{paddingTop:50}}>
                        <SegmentedControlTab
                            values={[lan.Bio, lan.Courses, lan.Badges,lan.Articles]}
