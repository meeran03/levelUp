...
import {View, ScrollView, StyleSheet, FlatList, ActivityIndicator,I18nManager} from 'react-native';
        ...
        return(
            this.state.data != null?
                ...
                <ScrollView style={Style.container}>
                    ...
                    <View style={{flex:1}}>
                        <Text style={Style.headTitle}>{lan.Latest_news}</Text>
                    ...
                    <View style={{flex:1}}>
                        ...
                        <Text style={Style.headTitle}>{lan.Latest_articles}</Text>
                        <View style={{height:15}}/>
