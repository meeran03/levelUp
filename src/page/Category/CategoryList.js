            ...
            this.state.data != null?
                <View style={{backgroundColor:Config.background}}>
                    <Header
                        ...
                        centerComponent={{text:lan.course_categories,numberOfLines:1,style:{color:'#fff',fontFamily:'robotobold'}}}
                    ...
                    return (
                        <TouchableOpacity onPress={()=>{this._clickItem(item)}} style={Style.item}>
                            ...
                            <View style={{paddingLeft:45}}>
                                ...
                                <Text style={{fontFamily:'robotolight',fontSize:13,color:Config.grayColor,opacity:0.8}}>{item.count} {lan.Courses}</Text>
                            </View>
