...
import { View, I18nManager,Text, FlatList, TouchableOpacity, StyleSheet } from 'react-native';
                    ...
                    <FlatList
                        ...
                        renderItem={({item}) =>
                            ...
                            <Card
                                ...
                                {(item.type == "webinar" || item.type == "course+webinar")?<View style={style.live}><Text style={{color:'#fff',fontWeight:'bold'}}>{lan.live}</Text></View>:null}
